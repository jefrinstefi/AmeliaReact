...
const AmeliaUpload = () => {
  ...
  const handleUpload = () => {
    ...
    fetch("http://52.12.103.246:8008/upload-transcript", requestOptions)
...
fetch("http://52.12.103.246:8008/analyze-all", requestOptions)
  .then((response) => response.json())
  ...
  // 03/18/2025 00:00
  fetch("http://52.12.103.246:8008/analysis-results", requestOptions)
    .then((response) => response.json())
    .then((result) => {
  ...
  fetch("http://52.12.103.246:8008/conversations", requestOptions)
    .then((response) => response.json())
    .then((result) => {
      console.log('result',result);
      setTotalConversations(result.total);
